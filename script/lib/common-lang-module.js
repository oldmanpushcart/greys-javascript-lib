...
define('__common_lang_array', function () {
    ...
    return {
         ...
         * @param array 待迭代数组
         * @returns {{hasNext: hasNext, next: next, remove: remove}}
         */
...
/**
 * 文本操作模块
 * 文本模块和字符串模块的最大区别在于,文本模块是对字符串的矩阵操作
 */
define('__common_lang_text', ['__common_lang_string'], function (string) {
    ...
    function textWidth(text) {
        ...
        return width == 0 ? string.length(text) : width;
    }
...
define('__common_lang_date', [], function () {
    return {
...
require(
    ['__common_lang_string', '__common_lang_array', '__common_lang_text', '__common_lang_java', '__common_lang_lock', '__common_lang_date'],
    function (string, array, text, java, lock, date) {
        module.exports = {
            array: array,
            string: string,
            text: text,
